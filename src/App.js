...
//                         <h4 className="text-lg font-semibold mb-2">Extracted Text:</h4>
//                         <pre className="bg-gray-100 p-4 rounded-md border border-gray-300 max-h-48 overflow-y-auto text-sm">{text}</pre>
//                         <button onClick={handlePDFDownload} className="mt-4 w-full bg-green-500 text-white py-2 rounded-md shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
//                             Download as PDF
//                         </button>
//                         <button onClick={handleTextDownload} className="mt-4 w-full bg-blue-500 text-white py-2 rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
//                             Download as Text
//                         </button>
//                     </div>
//                 )}
